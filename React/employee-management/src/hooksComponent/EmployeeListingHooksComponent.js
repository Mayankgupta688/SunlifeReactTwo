...
export default function EmployeeListingHooksComponent() {
    ...
    var [stockName, stockPrice] = useStockPrice("https://priceapi.moneycontrol.com/pricefeed/bse/equitycash/SBI")
    var [stockNameThermax, stockPriceThermax] = useStockPrice("https://priceapi.moneycontrol.com/pricefeed/nse/equitycash/T")

    var [timerData] = useCurrentTime()
    ...
    return (
        <div style={{margin: "20px"}}>
            ...
            <h1>Current Time is: {timerData}</h1><br/>

            <h2>Current Price of {stockName} is {stockPrice}</h2>
            <h2>Current Price of {stockNameThermax} is {stockPriceThermax}</h2>
